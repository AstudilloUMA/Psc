...
public class mergesort {
	...
	public static void main(String[] args) {
		try {
			...
			List<Integer> lista = crear_lista_aleatoria();
...
//Implementa la clase ejercicio1.Nodo - es una hebra
	...
	public void run() {
		try {
			...
			if (sz > 1) {
				...
				l1.addAll(lista.subList(0,lista.size()/2));

				List<Integer> l2 = new ArrayList<Integer>();
				l2.addAll(lista.subList((lista.size()/2),lista.size()));
