 ...
 * una secuencia de pares de d�gitos correspondientes al coeficiente y exponente
 * de cada monomio del polinomio, incluyendo los que tienen coeficiente nulo.
 * En ambos casos, suponemos que los coeficientes y exponentes son d�gitos del 0 al 9
 * (no hay n�meros superiores).
 * Por ejemplo, para el polinomio de ejemplo el fichero de texto estar�a compuesto
 ...
 *
 * La conversi�n de un valor de tipo �char� que contenga
 * un valor n�merico (ej. char c = �2�)
