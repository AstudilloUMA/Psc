...
/**
 * funcion auxiliar privada para crear un directorio vacío
 */
...
* entonces los bloques que ya hayamos reservado se devolverán a la lista de bloques libres y el puntero
* a los bloques de memoria tendrá un valor NULL. El tamaño del fichero también se cambiará para que sea 0.
*/
...
/*
* Se leen todos los datos del directorio desde fichero de texto cuyo nombre se indica como primer parámetro y se
* creará la lista enlazada con todos los ficheros en el segundo parámetro (lf).
...
/**
 * Se muestra por pantalla el contenido del directorio, con los datos de cada fichero en una línea distinta, con el siguiente formato:
